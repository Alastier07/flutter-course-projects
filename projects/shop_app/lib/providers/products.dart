...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSetProducts([bool filterByUser = false]) async {
    ...
    try {
      ...
      url = Uri.parse(
          'https://flutter-training-a2482-default-rtdb.asia-southeast1.firebasedatabase.app/userFavorites/$userId.json?auth=${authToken}');
  ...
  Future<void> updateProduct(String id, Product newProduct) async {
    ...
    if (prodIndex >= 0) {
      final url = Uri.parse(
          'https://flutter-training-a2482-default-rtdb.asia-southeast1.firebasedatabase.app/products/$id.json?auth=${authToken}');
